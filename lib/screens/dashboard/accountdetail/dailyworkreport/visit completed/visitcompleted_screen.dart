...
import 'Successfull-Visit/successfullvisitscreen.dart';

class VisitCompletedScreenNew extends StatelessWidget {
  const VisitCompletedScreenNew({super.key});
